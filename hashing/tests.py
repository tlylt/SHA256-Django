...
class UnitTestCase(TestCase):
    ...
    # always start with test_ for django to recognize it as test
    ...
    # need to go settings to create a testing database
    ...
    def test_bad_data(self):
        def badHash():
            hash = Hash()
            hash.hash = '2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824123213213213'
            hash.full_clean()
